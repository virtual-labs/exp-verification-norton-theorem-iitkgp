...
s2=parseFloat(document.getElementById('s2').value);
		...
		{
			alert("Please select S1 to Power and S2 to Short for case 2(a).")
		}
	}
function perform3(){	
var r1,r2,r3,v1,v2,rl1,s1,s2,tmp1,tmp2;
...
s2=parseFloat(document.getElementById('s2').value);
		...
		{c4=1;
			...
			document.f1.A13.value= ((tmp2 * tmp1) / (tmp1 + rl1)).toPrecision(5);
			dr8=((tmp2 * tmp1) / (tmp1 + rl1)).toPrecision(5);
	    }
		else
		{
			alert("Please find Isc and Rn first.")
		}
	}	
	function perform5(){
